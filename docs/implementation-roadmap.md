...
| `github_pr_run` | Inspect targeted PR comments/checks and bounded Actions run/job evidence, rerun failed jobs behind dry-run/confirmation, or create one PR through a guarded `gh` workflow |
