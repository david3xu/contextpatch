    ...
    json!({
        ...
        "process_execution": {
            ...
            "typed_workflows": {
                ...
                "azure_containerapp_op": "Previews by default, or applies asynchronously after a confirm, one typed Azure Container Apps write (container app update or az acr build) against a resource-group/app or registry the operator named in CONTEXTPATCH_AZURE_OPS_TARGETS / CONTEXTPATCH_AZURE_OPS_REGISTRIES; refuses credential-like variable names and builds from uncommitted changes.",
