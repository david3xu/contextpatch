...
pub(crate) fn read_range_definition() -> Value {
    json!({
...
pub(crate) fn artifact_delete_exact_definition() -> Value {
    json!({
...
pub(crate) fn read_write_receipts_definition() -> Value {
    json!({
...
pub(crate) fn diff_preview_definition() -> Value {
    json!({
...
pub(crate) fn replace_exact_definition() -> Value {
    json!({
...
pub(crate) fn status_guard_definition() -> Value {
    json!({
...
pub(crate) fn file_info_definition() -> Value {
    json!({
...
pub(crate) fn set_file_executable_definition() -> Value {
    json!({
...
pub(crate) fn list_directory_definition() -> Value {
    json!({
...
pub(crate) fn read_file_bytes_definition() -> Value {
    json!({
...
pub(crate) fn write_new_file_definition() -> Value {
    json!({
...
pub(crate) fn write_new_file_base64_definition() -> Value {
    json!({
...
pub(crate) fn write_existing_file_exact_hash_definition() -> Value {
    json!({
...
pub(crate) fn artifact_write_text_definition() -> Value {
    json!({
...
pub(crate) fn artifact_write_base64_definition() -> Value {
    json!({
...
pub(crate) fn bulk_replace_exact_definition() -> Value {
    json!({
...
pub(crate) fn bulk_write_new_files_base64_definition() -> Value {
    json!({
...
pub(crate) fn create_directory_definition() -> Value {
    json!({
