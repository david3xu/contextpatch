...
pub(crate) fn fixture_generator_run_definition() -> Value {
    json!({
...
pub(crate) fn base_image_check_run_definition() -> Value {
    json!({
...
pub(crate) fn fixture_manifest_verify_definition() -> Value {
    json!({
...
pub(crate) fn fixture_manifest_refresh_definition() -> Value {
    json!({
