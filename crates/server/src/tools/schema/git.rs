...
pub(crate) fn move_tracked_definition() -> Value {
    json!({
...
pub(crate) fn delete_guarded_definition() -> Value {
    json!({
...
pub(crate) fn git_commit_exact_definition() -> Value {
    json!({
...
pub(crate) fn git_commit_scoped_definition() -> Value {
    json!({
...
pub(crate) fn git_commit_prefix_definition() -> Value {
    json!({
...
pub(crate) fn git_stage_exact_definition() -> Value {
    json!({
...
pub(crate) fn git_staged_scope_check_definition() -> Value {
    json!({
...
pub(crate) fn git_restore_exact_definition() -> Value {
    json!({
...
pub(crate) fn delete_untracked_exact_definition() -> Value {
    json!({
...
pub(crate) fn delete_generated_prefix_definition() -> Value {
    json!({
...
pub(crate) fn git_remote_list_definition() -> Value {
    json!({
...
pub(crate) fn git_remote_check_definition() -> Value {
    json!({
...
pub(crate) fn git_branch_prepare_definition() -> Value {
    json!({
...
pub(crate) fn git_merge_readiness_definition() -> Value {
    json!({
...
pub(crate) fn git_push_exact_definition() -> Value {
    json!({
